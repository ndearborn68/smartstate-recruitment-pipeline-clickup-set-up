...
cp "$SCRIPT_DIR/com.smartstate.recruiter-sync.plist" "$PLIST_DIR/"
...
echo "   launchctl unload ~/Library/LaunchAgents/com.smartstate.recruiter-sync.plist"
